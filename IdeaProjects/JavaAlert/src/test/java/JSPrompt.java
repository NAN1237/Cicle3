...
public class JSPrompt {
    ...
    @Given("User Buka Websitenya the-internet.herokuapp.com\\/javascript_alertsPrompt")
    public void userBukaWebsitenyaTheInternetHerokuappComJavascript_alertsPrompt() throws InterruptedException {
